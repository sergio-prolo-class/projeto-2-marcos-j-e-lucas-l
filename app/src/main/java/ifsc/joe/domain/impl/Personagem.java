...
public abstract class Personagem {
    ...
    protected Personagem (int posX, int posY, String nomeImagem) {
        this.posX = posX;
        this.posY = posY;
        this.nomeImagem = nomeImagem;
        this.icone = this.carregarImagem(this.nomeImagem);
        this.atacando = false;
    }
    ...
    public void desenhar(Graphics g, JPanel painel) {
        ...
        this.icone = this.carregarImagem(this.nomeImagem + (atacando ? "2" : ""));
